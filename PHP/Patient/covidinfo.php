  ...
  <body>
    ...
    <h2><span id="country"></span> </h2>
      ...
      <div class="board">
        ...
        <div class="card cr"><i class="fas fa-exclamation-triangle"></i><h5>Critical Cases</h5><span id="critical"></span></div>
        <div class="card d"><i class="fa fa-times"></i><h5>Total Deaths</h5><span id="death"></span></div>
        <div class="card r"><i class="fas fa-user-check"></i><h5>Recovered Cases</h5><span id="recovered"></span></div>
        <div class="card t"><i class="fas fa-vials"></i><h5>Total Testes Done</h5><span id="tests"></span></div>
      </div>
    </div>
  </body>
</html>
